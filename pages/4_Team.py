...
st.markdown("""
About : I am passionate about software engineering with keen interest in data science ,automation , machine learning and game development. I keen in seeing technology being used to gain insights and solve real-world problems.
...
st.write("<b style='font-size: 20px;'>Dr. Shan-A-Khuda, Mohammad</b>", unsafe_allow_html=True)
st.write('Professor & Project Supervisor')
st.write('Leeds Beckett University,England, United Kingdom.')
st.markdown("""[Linked In](https://www.linkedin.com/in/mohammad-shan-a-khuda-8961051bb/)""")
